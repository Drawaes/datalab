...
namespace SqlServer.Core.Tls.Interop
{
    internal static partial class LibCrypto
    {
        ...
        public struct EVP_PKEY
        {
            ...
            public static bool operator ==(EVP_PKEY left, EVP_PKEY right) => left._ptr == right._ptr;

            public static bool operator !=(EVP_PKEY left, EVP_PKEY right) => !(left == right);
        }
    }
}
